  ...
  return (
    <div style={{ background: '#0A0A0B', minHeight: '100svh' }}>
      ...
      >
        ...
        <p className="font-body text-xs mb-12 mt-3" style={{ color: 'rgba(237,232,220,0.3)' }}>
      ...
      <footer style={{ borderTop: '1px solid rgba(237,232,220,0.07)', padding: 'clamp(24px,4vw,32px) clamp(24px,5vw,88px)' }}>
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-5">
            <Link to="/privacy" className="font-body text-xs transition-opacity hover:opacity-70" style={{ color: 'rgba(237,232,220,0.18)' }}>
              Privacy
            </Link>
            <Link to="/terms" className="font-body text-xs transition-opacity hover:opacity-70" style={{ color: 'rgba(237,232,220,0.18)' }}>
              Terms
            </Link>
            <a href="mailto:admin.team@motion-visual.com" className="font-body text-xs transition-opacity hover:opacity-70" style={{ color: 'rgba(237,232,220,0.18)' }}>
