...
const testimonials = [
  {
    quote: 'Bookings were up 34% the month after we went live. I\'d been putting off a new site for two years because every other quote felt like a gamble. This felt like a decision.',
    name: 'James T.',
    title: 'Owner, Thomas J Walls Coffee',
    initials: 'JT',
    stat: '+34%',
    statLabel: 'bookings within 30 days of launch',
  },
  {
    quote: 'We went from a £400 Wix site to something that looks like a luxury brand. Enquiries tripled in the first six weeks. I kept waiting for the catch — there wasn\'t one.',
    name: 'Priya K.',
    title: 'Director, Texture Lounge',
    initials: 'PK',
    stat: '3×',
    statLabel: 'enquiry volume after launch',
  },
  {
    quote: 'Three other agencies quoted me 3–4 months. Motion Visual delivered in 12 days, and it looks better than anything they showed me in their pitch decks.',
    name: 'Marcus R.',
    title: 'GM, CHE Edinburgh',
    initials: 'MR',
    stat: '12',
    statLabel: 'days from brief to live site',
  },
  {
    quote: 'New clients mention the website before they\'ve even sat down. That never happened before. It\'s become part of how we sell — which I didn\'t expect from a website.',
    name: 'Amir H.',
