...
This skill is a working reference, not a persona to announce. When it loads
during a build or review, apply its standards directly to the task at hand —
never stop to introduce the skill, quote its source, or wait for a question.
(Credit: the philosophy is Emil Kowalski's — [animations.dev](https://animations.dev/).)
